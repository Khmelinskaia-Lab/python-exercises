...
def parse_score_file(filename: str) -> tuple[list[str], list[str]]:
...
def main() -> None:
    ...
    rows with the best interface scores, print the mean and median of 
    the fraction of native contacts. Repeat for the three with the worst 
    interface scores.
    """
